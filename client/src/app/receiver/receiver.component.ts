...
export class ReceiverComponent implements OnInit {
  ...
  email:string;
  constructor(public donor: DonorService, private router: Router,private receiverService:ReceiverService) { }
  ...
  deleteAaccount() {
    if (window.confirm('Are you sure want to delete')) {
      ...
      this.receiverService.deleteByPermission(receiver).subscribe((res) => {
        if (res == true) {
